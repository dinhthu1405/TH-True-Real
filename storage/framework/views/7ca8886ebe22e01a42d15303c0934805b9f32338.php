...
<body>
  <?php if($pageId=="login" || $pageId=="register"): ?>
  <main class="py-4">
  ...
  <!-- jQuery UI 1.11.4 -->
  <script src="<?php echo e(asset('asset/plugins/jquery-ui/jquery-ui.min.js')); ?>"></script>
  ...
  <!-- Sparkline -->
  <script src="<?php echo e(asset('asset/plugins/sparklines/sparkline.js')); ?>"></script>
  <!-- JQVMap -->
  <script src="<?php echo e(asset('asset/plugins/jqvmap/jquery.vmap.min.js')); ?>"></script>
  <script src="<?php echo e(asset('asset/plugins/jqvmap/maps/jquery.vmap.usa.js')); ?>"></script>
  <!-- jQuery Knob Chart -->
  <script src="<?php echo e(asset('asset/plugins/jquery-knob/jquery.knob.min.js')); ?>"></script>
  <!-- daterangepicker -->
  <script src="<?php echo e(asset('asset/plugins/moment/moment.min.js')); ?>"></script>
  <script src="<?php echo e(asset('asset/plugins/daterangepicker/daterangepicker.js')); ?>"></script>
  <!-- Tempusdominus Bootstrap 4 -->
  <script src="<?php echo e(asset('asset/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js')); ?>"></script>
  <!-- Summernote -->
  <script src="<?php echo e(asset('asset/plugins/summernote/summernote-bs4.min.js')); ?>"></script>
  <!-- overlayScrollbars -->
  <script src="<?php echo e(asset('asset/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js')); ?>"></script>
  <!-- AdminLTE App -->
  ...
  <script src="<?php echo e(asset('asset/dist/js/pages/dashboard.js')); ?>"></script>
</body>

</html><?php /**PATH D:\Do_an_local\TH-True-Real\resources\views/layouts/app.blade.php ENDPATH**/ ?>