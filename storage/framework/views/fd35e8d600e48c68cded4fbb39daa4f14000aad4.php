                        ...
                        <div class="row">
                            <div class="col-md-6 pr-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="mobile" type="text" name="SDT" class="form-control" placeholder="Nhập Số điện thoại">
                                </div>
                                <div class="form-group">
                                    <label>Ngày Sinh</label>
                                    <input type="date" name="NgaySinh" class="form-control" min="1" placeholder="Ngày Sinh">
                                </div>
                            </div>
