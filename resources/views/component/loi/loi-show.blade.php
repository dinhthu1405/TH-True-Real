                        ...
                        <table class="table" style="text-align: center;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @if (Auth::user()->phan_quyen == 1)
                                    <td>
                                        <a href="{{ route('loi.xoa', $loi->id) }}" onclick="return confirm('Bạn có chắc muốn xoá máy này')"><button class="btn btn-danger" type="submit">Xóa</button></a>
                                        <!-- </a> -->
                                    </td>
                                    <td><a href="{{ route('loi.edit', $loi->id) }}"><button class="btn btn-warning">Sửa</button></a></td>
                                    @endif
